    ...
    return (
        <div className="py-16 px-6 bg-white flex justify-center">
            ...
            >
                ...
                <input
                    type="email"
                    name="email" placeholder="Your Email"  className="input input-bordered w-full mb-4"
                    onChange={handleChange}
                    required
                />

                <textarea
                    name="message" placeholder="Your Message" className="textarea textarea-bordered w-full mb-4" rows="4"
                    onChange={handleChange}
                    required
                ></textarea>
